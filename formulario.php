        ...
        <form id="form" action="salvaFormulario.php" method="POST">
            ...
            <div>
                <input type="password" name="senha" id="senha" placeholder="Senha..." class="inputs required">
                         ...
                         <!-- <span class="span-required">Praesent egestas Praesent egestas</span> -->   <textarea class="inputs" name="descricao" id="descricao" cols="25" rows="10" placeholder="Informações Adicionais..."></textarea><br>
